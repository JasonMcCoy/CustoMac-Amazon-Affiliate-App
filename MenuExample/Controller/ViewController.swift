...
extension ViewController: MenuViewControllerDelegate {
    func menu(_: MenuViewController, didSelectItemAtIndex index: Int, atPoint point: CGPoint) {
        ...
        let content = storyboard!.instantiateViewControllerWithIdentifier("Content") as! NewContentViewController
//        content.typeValue = contentType;
        content.selectedIndex = Int32(selectedIndex);
